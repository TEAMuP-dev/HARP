...
void VerticalLayoutViewport::visibleAreaChanged (const Rectangle<int>& newVisibleArea)
{
...
OverlayComponent::OverlayComponent (PlayHeadState& playHeadStateIn, TimeToViewScaling& timeToViewScalingIn)
...
void OverlayComponent::setSelectedTimeRange (std::optional<ARA::ARAContentTimeRange> timeRange)
{
