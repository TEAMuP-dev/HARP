...
DocumentView::DocumentView (ARAEditorView& editorView, PlayHeadState& playHeadState)
...
void DocumentView::didAddMusicalContextToDocument (ARADocument*, ARAMusicalContext* musicalContext)
{
if (selectedMusicalContext == nullptr)
            selectMusicalContext (musicalContext);}

void DocumentView::willDestroyMusicalContext (ARAMusicalContext* musicalContext)
...
void DocumentView::didAddRegionSequenceToDocument (ARADocument*, ARARegionSequence*)
{
        invalidateRegionSequenceViews();
}

void DocumentView::willRemoveRegionSequenceFromDocument (ARADocument*, ARARegionSequence* regionSequence)
{
...
void DocumentView::onHideRegionSequences (const std::vector<ARARegionSequence*>& regionSequences)
{
...
void DocumentView::selectMusicalContext (ARAMusicalContext* newSelectedMusicalContext)
{
...
template <typename T>
void DocumentView::layOutVertically (Rectangle<int> bounds, T& components, int verticalOffset)
{
