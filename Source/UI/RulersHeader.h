...
private:
  Label chordsLabel, barsLabel,
      timeLabel; /**< Labels for chords, bars, and time */
};
...
//     RulersHeader()
//     {
//         chordsLabel.setText ("Chords",
//         NotificationType::dontSendNotification); addAndMakeVisible
//         (chordsLabel);
...
//         (ResizableWindow::backgroundColourId)); g.fillRect (bounds);
//         g.setColour (getLookAndFeel().findColour
//         (ResizableWindow::backgroundColourId).contrasting()); g.drawRect
