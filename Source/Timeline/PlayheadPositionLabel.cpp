/**
  ...
  * 
  * @brief This class handles interactions with a playback region on the plugins UI.
...
void PlayheadPositionLabel::selectMusicalContext (ARAMusicalContext* newSelectedMusicalContext)
{
