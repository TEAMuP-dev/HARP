 ...
 * @brief Specialises ARA's document controller, with added functionality for audio modifications, playback rendering, and editor rendering.
 */
class TensorJuceDocumentControllerSpecialisation  : public ARADocumentControllerSpecialisation,
...
protected:
    void willBeginEditing (ARADocument*) override;  ///< Called when beginning to edit a document.
    void didEndEditing (ARADocument*) override;  ///< Called when editing a document ends.
    ...
    bool doRestoreObjectsFromStream (ARAInputStream& input,
                                     const ARARestoreObjectsFilter* filter) noexcept override;  ///< Restores objects from a stream.
    bool doStoreObjectsToStream (ARAOutputStream& output, const ARAStoreObjectsFilter* filter) noexcept override;  ///< Stores objects to a stream.
