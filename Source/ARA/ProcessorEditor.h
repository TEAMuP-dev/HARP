 ...
 * and implements Button::Listener, Slider::Listener, and ComboBox::Listener interfaces.
 */
...
public:
     ...
     */
    explicit TensorJuceProcessorEditor (ARADemoPluginAudioProcessorImpl& p, EditorRenderer* er);
