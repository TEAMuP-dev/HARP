/**
  ...
  * 
  * @brief Base class for any models that utilize a web api to process information.
  * Currently we provide an implmentation of a wave 2 wave web based model. 
  * We use the gradio python client to communicate with a gradio server.
