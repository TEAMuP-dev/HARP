...
bool TorchModel::to_buffer(const torch::Tensor &src_tensor, juce::AudioBuffer<float> &dest_buffer) {
...
void TorchWave2Wave::process(juce::AudioBuffer<float> *bufferToProcess, int sampleRate) const {
...
torch::Tensor Resampler::resample(const torch::Tensor &waveform, int sampleRateIn, int sampleRateOut) const {
