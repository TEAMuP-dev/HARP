/**
  ...
  * 
  * @brief This is the interface for any kind of deep learning model. this will be the base class for
  * wave 2 wave, wave 2 label, text 2 wave, midi 2 wave, wave 2 midi, etc. 
