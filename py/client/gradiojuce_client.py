...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', required=True, choices=['get-ctrls', 'predict'], help='The mode of operation.')
    parser.add_argument('--ctrls-path', help='The path to the controls file.')
